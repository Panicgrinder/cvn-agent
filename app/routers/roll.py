...
from app.schemas import RollRequest, RollResponse
...
async def roll_dice(request: RollRequest) -> RollResponse:
    """
    Würfelt einen Würfelausdruck und gibt das Ergebnis zurück.
    
    Beispiel: 2d6+3 würfelt zwei sechsseitige Würfel und addiert 3.
    """
    try:
        ...
        raise HTTPException(
            status_code=400, 
            detail=f"Fehler beim Würfeln: {str(e)}"
        )
